...
@section('content')
                                    <div class="card card-custom gutter-b example example-compact">
											<div class="card-header">
												<h3 class="card-title">Adicionar &Aacute;rea </h3>
											...
											<!--begin::Form-->
											<form class="form" action="{{url('/area')}}" method="post">
                                                @csrf 
												<div class="card-body">
													<h3 class="font-size-lg text-dark font-weight-bold mb-6">Informaci&oacute;n del &Aacute;rea:</h3>
													<div class="mb-15">
														...
														<div class="form-group row">
															...
															<div class="col-lg-6">
																<input id="description" type="text" name="description" class="form-control" placeholder="descripci&oacute;n" />
