...
@section('content')
                                    <div class="card card-custom gutter-b example example-compact">
											<div class="card-header">
												<h3 class="card-title">Adicionar analista </h3>
											...
											<!--begin::Form-->
											<form class="form" action="{{url('/qualityAnalyst')}}" method="post">
                                                @csrf 
												<div class="card-body">
													...
													<div class="mb-15">
														...
														<div class="form-group row">
														 ...
														 <div class="form-group row">
															...
															<div class="col-lg-6">
																<input  id="lastname" type="text" name="lastname" class="form-control" placeholder="apellidos" />
														...
														<div class="form-group row">
															...
															<div class="col-lg-6 col-md-9 col-sm-12">
																<input id="user" type="text" name="user" class="form-control" placeholder="descripci&oacute;n" />
															...
															<div class="col-lg-6 col-md-9 col-sm-12">
																<input id="password" type="password" name="password" class="form-control" placeholder="descripci&oacute;n" />
														...
														<div class="form-group row">
															...
															<div class="col-lg-6 col-md-9">
																<input id="email" type="text" name="email" class="form-control" placeholder="descripci&oacute;n" />
															...
															<label class="col-form-label text-right col-lg-3">Tel&eacute;fono:</label>
														 	  <div class="col-lg-6 col-md-9 col-sm-12">
																<input id="phone" type="text" name="phone" class="form-control" placeholder="descripci&oacute;n" />
