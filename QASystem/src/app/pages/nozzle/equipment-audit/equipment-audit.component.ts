...
import { EquipmentAuditService } from '../../../services/nozle/equipment-audit.service';


@Component({
  selector: 'app-equipment-audit',
  templateUrl: './equipment-audit.component.html',
  styleUrls: ['./equipment-audit.component.scss']
})
export class EquipmentAuditComponent implements OnInit {
  ...
  /* ******************* */
  constructor(
    private servicio: EquipmentAuditService,
