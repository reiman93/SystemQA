...
import { TurnTypeService } from 'src/app/services/nomenclators/turn-type.service';
...
export class ListComponent implements OnInit {
  ...
  constructor(
    public service: TurnTypeService,
  ...
  update(id: string) {
    this.router.navigate(['pages/nomenclators/turn/edit', id]);
  }
