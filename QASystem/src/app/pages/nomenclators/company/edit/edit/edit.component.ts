...
import { CompanyService } from 'src/app/services/nomenclators/company.service';
...
export class EditComponent implements OnInit {
        ...
        constructor(
                ...
                private servicio: CompanyService,
        ...
        findById() {
                ...
                this.servicio.get(this.id, "company").subscribe((result: any) => {
