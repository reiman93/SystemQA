...
import { IJanitor } from './../../interfaces/entity-interfaces';
...
export class JanitorService {
  ...
  findAllPagination(
    ...
    return this.httpClient.post<any>( this.enviroment.config.url + 'storeJanitor',
  ...
  create(data: any, service: string): Observable<any> {
    return this.httpClient.post<any>( this.enviroment.config.url + service, {
      ...
      phone: data.phone,
      cleaning_companies_id: parseInt(data.company),
      turn_types_id: parseInt(data.turn)
