...
import { ISopLog } from '../../interfaces/entity-interfaces';
...
export class AnimalHandingService {
  url = conf.url;
  ...
  findAllPagination(
    ...
    return this.httpClient.post<any>( this.enviroment.config.url + 'storeAnimalHanding',
